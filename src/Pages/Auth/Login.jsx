    ...
    return (
        <div className="w-full my-20 container mx-auto max-w-md p-4 rounded-md shadow sm:p-8 dark:bg-gray-50 dark:text-gray-800">
            ...
            <form className="space-y-8" onSubmit={handleSubmit(onSubmit)}>
                ...
                <input type="submit" className="w-full btn border-none px-8 py-3 font-semibold rounded-md dark:bg-violet-600 dark:text-gray-50" value={'Sign In'}></input>
            </form>
            <p>New here? <span className="underline"><Link to={'/register'}>Sign Up</Link></span></p>
        </div>
    );
};
